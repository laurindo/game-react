...
/***/ function(module, exports, __webpack_require__) {
	...
	var _menuStart = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = function Button(props) {
	    ...
	    var getButtonMenu = function getButtonMenu() {
	        return _react2.default.createElement(
	            'button',
	            { className: 'btnStart', onClick: props.clickCallback },
	            _general_constant2.default.button.START
	        );
	    };

	    var getButtonYes = function getButtonYes() {
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(
	                'button',
	                { className: 'btnYes', onClick: props.clickCallback },
	                _general_constant2.default.button.YES
	            )
	        );
	    };

	    var getButtonNo = function getButtonNo() {
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(
	                'button',
	                { className: 'btnNo', onClick: props.clickCallback },
	                _general_constant2.default.button.NO
	            )
	        );
	    };

	    var getButtonQuit = function getButtonQuit() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'btn' },
	            _react2.default.createElement(
	                'button',
	                { className: 'btnQuit', onClick: props.clickCallback },
	                props.title
	            )
	        );
	    };

	    var getButtonNormal = function getButtonNormal() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'btn' },
	            _react2.default.createElement(
	                'button',
	                { className: 'btnNormal', onClick: props.clickCallback },
	                props.title
	            )
	        );
	    };
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'div',
	            { className: 'centerButton centerPromptButtons' },
	    ...
	    _createClass(Dialog, [{
	        ...
	        value: function getButtons() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_button2.default, { btnType: 'btnYes', clickCallback: this.props.callbackYes }),
	                _react2.default.createElement(_button2.default, { btnType: 'btnNo', clickCallback: this.props.callbackNo })
	            );
	        }
	    }, {
	        key: 'choiceBoard',
	        value: function choiceBoard(event) {
	            var opt = event.target.parentElement.getAttribute('target');
	        ...
	        key: 'getBoardSuggestion',
	        value: function getBoardSuggestion() {
	            var that = this;
	            var optionsToDisable = [1, 2, 3]; //options that deck will disable
	            var shuffleChoices = _brain2.default.shuffleList(optionsToDisable);
	            var choices = shuffleChoices.map(function (item, index) {
	                return _react2.default.createElement(
	                    'div',
	                    { key: index, className: 'col-xs-12 col-sm-4 col-md-4 col-xl-4 col-lg-4' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'helpOptions', target: item, onClick: function onClick(event) {
	                                return that.choiceBoard(event);
	                            } },
	                        _react2.default.createElement(
	                            'p',
	                            null,
	        ...
	        key: 'getDeckSuggestion',
	        value: function getDeckSuggestion() {
	            var that = this;
	            var wrongOrCorrect = _brain2.default.wrongOrCorrect(this.props);
	            var itemsQuestion = ['a', 'b', 'c', 'd'];
	            var choices = [0, 1, 2, 3].map(function (item, index) {
	                return _react2.default.createElement(
	                    'div',
	                    { key: index, className: 'col-xs-12 col-sm-3 col-md-3 col-xl-3 col-lg-3' },
	                    _react2.default.createElement(
	                        'div',
	                        null,
	            ...
	            var getAnswerFinal = function getAnswerFinal() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(_button2.default, { btnType: 'btnQuit', title: getAnswerFinal() })
	                ),
	                choices,
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(_button2.default, { btnType: 'btn', title: 'OK', clickCallback: function clickCallback() {
	        ...
	        key: 'getGuessSuggestion',
	        value: function getGuessSuggestion() {
	            var that = this;
	            var wrongOrCorrect = _brain2.default.wrongOrCorrect(this.props);
	            var careers = _brain2.default.getGuessProfessionalCareer();
	            var itemsQuestion = ['a', 'b', 'c', 'd'];
	            var getAnswerFinal = function getAnswerFinal() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-sm-12 col-md-9 col-xl-9 col-lg-9' },
	                        _react2.default.createElement(
	                            'p',
	                            { className: 'descriptionGuess' },
	                            'O(a) ' + careers + ' afirma que a resposta correta \xE9: '
	                        ),
	                        _react2.default.createElement(
	                            'label',
	                            { className: 'answerLabelGuess' },
	                            '(',
	                            getAnswerFinal(),
	                            ')'
	                        )
	        ...
	        key: 'getContentLose',
	        value: function getContentLose() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'loadingRanking' },
	                'carregando ranking...'
	            );
	        }
	    }, {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('div', { className: 'dropscreen' }),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        this.props.type && this.props.type !== 'lose' ? this.getContent() : ''
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        this.props.type && this.props.type === 'lose' ? this.getContentLose() : ''
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        this.props.type && this.props.type === 'score' ? this.getContentScore() : ''
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        this.props.type === 'prompt' ? this.getButtons() : ''
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var QUESTIONS = _dataQuestions2.default.QUIZZ_OBJ;
	var SIZE_QUIZZ_OBJ = _dataQuestions2.default.QUIZZ_OBJ.length;
	var CAREERS = _career2.default.getCareers();
	var track = [];

	/*
	    Check if arrays contains item repeated
	*/
	var contains = function contains(list, value) {
	    var i = list.length;
	    while (i--) {
	        if (list[i] === value) {
	            return true;
	...
	*/
	var generateRandomNumbers = function generateRandomNumbers(size, jumpLoop, position) {
	    if (jumpLoop) {
	        rand = Math.floor(Math.random() * SIZE_QUIZZ_OBJ);
	        var isContains = contains(track, rand);
	        if (!isContains) {
	        ...
	        for (var i = 0; i < size; i++) {
	            ...
	            var _isContains = contains(track, rand);
	            if (!_isContains) {
	                track[i] = rand;
	            } else {
	...
	*/
	...
	var wrongOrCorrect = function wrongOrCorrect(props) {
	    ...
	    if (wrongOrCorrect === 0) {
	        //WRONG
	        var wrong = Math.floor(Math.random() * 4 + 1) * 25;
	        return {
	            answerPercent: wrong,
	        ...
	        //CORRECT
	        var correct = Math.floor(Math.random() * 4 + 1) * 25;
	...
	var getQuestionsSorted = function getQuestionsSorted() {
	    var questionsSorted = [];
	    var getRandomNumberQuestions = generateRandomNumbers(SIZE_QUIZZ_OBJ);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionHelp = function (_Component) {
	    _inherits(QuestionHelp, _Component);

	    function QuestionHelp(props) {
	        _classCallCheck(this, QuestionHelp);

	        var _this = _possibleConstructorReturn(this, (QuestionHelp.__proto__ || Object.getPrototypeOf(QuestionHelp)).call(this, props));
	    ...
	    _createClass(QuestionHelp, [{
	        key: 'getHelp',
	        value: function getHelp(type) {
	            switch (type) {
	                case "board":
	        ...
	        key: 'renderIcon',
	        value: function renderIcon(icon, index) {
	            var that = this;
	            var renderNormalIcon = function renderNormalIcon() {
	                return _react2.default.createElement(
	                    'div',
	            ...
	            var renderIconDisabled = function renderIconDisabled() {
	                return _react2.default.createElement(
	                    'div',
	        ...
	        key: 'iconsHelp',
	        value: function iconsHelp() {
	            var that = this;
	            var icons = _general_constant2.default.icons.map(function (icon, index) {
	                return that.renderIcon(icon, index);
	            });
	            return icons;
	        }
	    }, {
	        key: 'closeDialog',
	        value: function closeDialog(opt) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'questionHelp col-xs-12 col-sm-12 col-md-6 col-lg-6' },
	                this.state.showScore ? _react2.default.createElement(_dialog2.default, { type: 'score', message: _general_constant2.default.SCORE }) : '',
	                this.state.showDialogExitedGame ? _react2.default.createElement(_dialog2.default, { type: 'lose', message: _general_constant2.default.YOU_LOSE }) : '',
	                this.state.showDialogQuit ? _react2.default.createElement(_dialog2.default, { type: 'prompt', message: _general_constant2.default.WANT_TO_QUIT, callbackYes: function callbackYes() {
	                        _this2.closeDialogQuitGame();
	                    }, callbackNo: function callbackNo() {
	                        _this2.closeDialog();
	                    } }) : '',
	                this.state.showDialog ? _react2.default.createElement(_dialog2.default, { message: this.state.message, type: this.state.helpType, callback: function callback(opt) {
	                        _this2.closeDialog(opt);
	                    }, questions: this.props.questions, correctAnswer: this.props.correctAnswer, selectedQuestion: this.props.selectedQuestion }) : '',
	                _react2.default.createElement(
	                    'div',
	                    { className: 'card' },
	                    _react2.default.createElement(
	                        'h6',
	                        { className: 'helpTitle' },
	                        _general_constant2.default.HELP
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                    ...
	                    _react2.default.createElement(_button2.default, { title: _general_constant2.default.QUIT, btnType: 'btnQuit', clickCallback: function clickCallback() {
	                            _this2.askedExit();
	                        } })
	                )
	            );
